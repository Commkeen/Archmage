...
namespace Archmage.Content.Spells
{
    class Spell_PhotonSpike:Spell
    {
        ...
        public Spell_PhotonSpike(PlayScene scene, int ownerID)
            : base(ownerID)
        {
            ID = "photonSpike";
            Name = "Photon Spike";
            ...
            Description = "Does 2 energy damage.";
        }
        ...
        public override bool CastAtTarget(IntVector2 target)
        {
            ...
            _scene.WriteMessage("You fire a ray of energy!");
            ...
            fx.Init(currentCaster.Position, currentTarget, new Color(libtcod.TCODColor.yellow), new SpecialEffect.OnSpecialEffectEndCallback(OnSpecialEffectEnd));
