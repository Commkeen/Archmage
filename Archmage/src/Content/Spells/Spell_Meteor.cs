...
namespace Archmage.Content.Spells
{
    class Spell_Meteor:Spell
    {
        ...
        public override bool CastAtTarget(IntVector2 target)
        {
            ...
            _scene.WriteMessage("You fling a massive meteor at your enemy!");
            ...
            fx.Init(currentCaster.Position, currentTarget, new Color(libtcod.TCODColor.red), new SpecialEffect.OnSpecialEffectEndCallback(OnSpecialEffectEnd));
